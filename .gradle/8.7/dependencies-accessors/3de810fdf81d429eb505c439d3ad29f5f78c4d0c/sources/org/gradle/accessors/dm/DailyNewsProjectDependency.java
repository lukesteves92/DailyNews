...
@NonNullApi
public class DailyNewsProjectDependency extends DelegatingProjectDependency {

    @Inject
    public DailyNewsProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
