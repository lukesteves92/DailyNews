...
+ (void)Skie_Suspend__10__awaitContentDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__10__awaitContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__11__discardDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver max:(int64_t)max suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__11__discard(dispatchReceiver:max:suspendHandler:)")));
+ (void)Skie_Suspend__12__peekToDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver destination:(SharedKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__12__peekTo(dispatchReceiver:destination:destinationOffset:offset:min:max:suspendHandler:)")));
+ (void)Skie_Suspend__13__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKtor_ioChunkBuffer *)dst suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__13__readAvailable(dispatchReceiver:dst:suspendHandler:)")));
+ (void)Skie_Suspend__14__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__14__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__15__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__15__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__16__readAvailableDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__16__readAvailable(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__17__readBooleanDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__17__readBoolean(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__18__readByteDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__18__readByte(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__19__readDoubleDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__19__readDouble(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__20__readFloatDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__20__readFloat(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__21__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKtor_ioChunkBuffer *)dst n:(int32_t)n suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__21__readFully(dispatchReceiver:dst:n:suspendHandler:)")));
+ (void)Skie_Suspend__22__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(SharedKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__22__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__23__readFullyDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__23__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
...
+ (void)Skie_Suspend__25__readIntDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__25__readInt(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__26__readLongDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__26__readLong(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__27__readPacketDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver size:(int32_t)size suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__27__readPacket(dispatchReceiver:size:suspendHandler:)")));
+ (void)Skie_Suspend__28__readRemainingDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver limit:(int64_t)limit suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__28__readRemaining(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__29__readShortDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__29__readShort(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__30__readSuspendableSessionDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver consumer:(id<SharedKotlinSuspendFunction1>)consumer suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__30__readSuspendableSession(dispatchReceiver:consumer:suspendHandler:)")));
+ (void)Skie_Suspend__31__readUTF8LineDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver limit:(int32_t)limit suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__31__readUTF8Line(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__32__readUTF8LineToDispatchReceiver:(id<SharedKtor_ioByteReadChannel>)dispatchReceiver out:(id<SharedKotlinAppendable>)out limit:(int32_t)limit suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__32__readUTF8LineTo(dispatchReceiver:out:limit:suspendHandler:)")));
+ (void)Skie_Suspend__33__invokeDispatchReceiver:(id<SharedKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__33__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__34__executeDispatchReceiver:(id<SharedKtor_client_coreHttpClientEngine>)dispatchReceiver data:(SharedKtor_client_coreHttpRequestData *)data suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__34__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__35__fetchArticlesDispatchReceiver:(id<SharedArticlesRepository>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__35__fetchArticles(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__36__getArticlesDispatchReceiver:(SharedArticlesUseCase *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__36__getArticles(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__3__fetchArticlesDispatchReceiver:(SharedArticlesService *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__fetchArticles(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__4__joinDispatchReceiver:(id<SharedKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__4__join(dispatchReceiver:suspendHandler:)")));
...
+ (void)Skie_Suspend__5__executeDispatchReceiver:(SharedKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__5__execute(dispatchReceiver:context:subject:suspendHandler:)")));
+ (void)Skie_Suspend__6__invokeDispatchReceiver:(id<SharedKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__7__bodyDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(SharedKtor_utilsTypeInfo *)info suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__7__body(dispatchReceiver:info:suspendHandler:)")));
+ (void)Skie_Suspend__8__bodyNullableDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(SharedKtor_utilsTypeInfo *)info suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__8__bodyNullable(dispatchReceiver:info:suspendHandler:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
+ (void)Skie_Suspend__9__getResponseContentDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__9__getResponseContent(dispatchReceiver:suspendHandler:)")));
@end
